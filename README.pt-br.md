...
<p align="center">
  <img
    src="https://img.shields.io/github/languages/count/guipmdev/todo-list?color=%2304D361&labelColor=202024&label=linguagens"
    alt="Contagem de linguagens do repositório"
  />
  <img
    src="https://img.shields.io/github/repo-size/guipmdev/todo-list?labelColor=202024&label=tamanho do repo"
    alt="Tamanho do repositório"
  />
  <img
    src="https://img.shields.io/github/commit-activity/m/guipmdev/todo-list?color=black&labelColor=202024&label=atividade de commits"
  ...
  >
    <img
      src="https://img.shields.io/github/last-commit/guipmdev/todo-list?labelColor=202024&label=último commit"
      alt="Último commit"
    />
  </a>
...
Esse projeto é uma aplicação web desenvolvida em _React_ que permite aos usuários criar, concluir e excluir tarefas, tendo uma interface fácil de usar que auxilia no gerenciamento eficaz de afazeres.

Seu objetivo principal é ajudar as pessoas a manter o controle de suas tarefas e aumentar sua produtividade, fornecendo um sistema de gerenciamento de tarefas simples e intuitivo.
