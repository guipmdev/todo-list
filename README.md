...
<p align="center">
  <img
    src="https://img.shields.io/github/languages/count/guipmdev/todo-list?color=%2304D361&labelColor=202024"
    alt="Repository language count"
  />
  <img
    src="https://img.shields.io/github/repo-size/guipmdev/todo-list?labelColor=202024"
    alt="Repository size"
  />
  <img
    src="https://img.shields.io/github/commit-activity/m/guipmdev/todo-list?color=black&labelColor=202024"
    alt="Commit activity"
  />
  <a
  ...
  >
    <img
      src="https://img.shields.io/github/last-commit/guipmdev/todo-list?labelColor=202024"
      alt="Last commit"
    />
  </a>
...
This project is a web application developed in _React_ that allows users to create, complete and delete tasks, with an easy-to-use interface that helps with effective task management.

Its main objective is to help people keep track of their tasks and increase their productivity by providing a simple and intuitive task management system.
